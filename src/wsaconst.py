...
WSA_URI_MODIFY_PARTITION_LINK = '/api/partition-links/%s/operations/modify'

WSA_URI_DELETE_PARTITION_LINK = '/api/partition-links/%s/operations/delete'

# For secure boot certificate management
WSA_URI_IMPORT_CPC_CERTIFICATE = '/api/cpcs/%s/operations/import-certificate'

WSA_URI_GET_UPDATE_DELETE_CPC_CERTIFICATE = '/api/certificates/%s'

WSA_URI_LIST_CERTIFICATE = '/api/certificates'

WSA_URI_ASSIGN_CERTIFICATE_TO_PARTITION = '/api/partitions/%s/operations/assign-certificate'

WSA_URI_UNASSIGN_CERTIFICATE_FROM_PARTITION = '/api/partitions/%s/operations/unassign-certificate'
